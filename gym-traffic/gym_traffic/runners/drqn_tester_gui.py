...
class DRQNTesterGUI(object):
  ...
  def __init__(self):
    ...
    self.e = 0.0 #The chance of chosing a random action
    self.num_episodes = 50 #How many episodes of game environment to train network with.
